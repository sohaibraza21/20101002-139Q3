...
using Abdul_Rehman_Asghar.Models;
...
namespace Abdul_Rehman_Asghar.Controllers
{
    public class M_ProductController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Product_ID,Product_Name,Product_Description,Product_Picture,Product_SalePrice,Product_PurchasePrice,Product_Category_FID")] M_Product m_Product)
        {
